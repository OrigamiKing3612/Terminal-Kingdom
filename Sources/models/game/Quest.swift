enum Quest: Codable, Equatable {
	...
	var label: String {
		...
		switch self {
			...
			case .blacksmith7:
				switch Game.shared.stages.blacksmith.stage7Stages {
			...
			case .blacksmith8:
				switch Game.shared.stages.blacksmith.stage8Stages {
			...
			case .mine4:
				switch Game.shared.stages.mine.stage4Stages {
			...
			case .mine6:
				switch Game.shared.stages.mine.stage6Stages {
			...
			case .mine10:
				switch Game.shared.stages.mine.stage10Stages {
