struct KingNPC {
    ...
    static func firstDialogue() {
        ...
        MessageBox.message("Now you might be wondering what buttons to press. If you press the \("i".styled(with: .bold)), \("space".styled(with: .bold)), or \("enter".styled(with: .bold)) key, you can interact with the tile you are on.", speaker: .king)
