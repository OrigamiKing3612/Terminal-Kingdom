enum SVLeadCarpenterNPC: StartingVillageNPC {
	static func talk() async {
		if await Game.shared.stages.blacksmith.stage3Stages == .goToCarpenter {
			await MessageBox.message("Here are your sticks.", speaker: .lead_carpenter)
			...
			await MessageBox.message("I'm busy here...", speaker: .lead_carpenter)
		}
	}
}
